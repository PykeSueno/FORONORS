...
export function DrugsPageClient({
  ...
  gofastRuns: Array<{ id: number; created_at: string; user_name: string | null; status: 'success' | 'arrested'; item_name: string; item_image: string | null; quantity: number; money_amount: number; lost_money: number; seized_quantity: number; stock_after: number; money_after: number | null; participants?: Array<{ id: string; label: string }> }>;
}) {
