      ...
      <section className="glass-card p-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[#f1d2ae]">Grade: {role || 'Utilisateur'} · Salaire estimé semaine: {formatUsd(payEstimateCurrent)} · Semaine passée: {formatUsd(payEstimatePrevious)}</p>
          </div>
