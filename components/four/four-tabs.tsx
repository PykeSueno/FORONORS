...
export function FourTabs({
  ...
  active: 'four' | 'history' | 'stats' | 'messages' | 'partner';
  ...
  return (
    <div className="mb-4 flex flex-wrap gap-2">
      {canSeeTransactions ? <Link href="/dashboard/four" className={`filter-pill ${active === 'four' ? 'filter-pill-active' : ''}`}>Transactions</Link> : null}
