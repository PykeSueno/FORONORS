...
export const PERMISSION_LABELS: Record<string, { module: string; label: string; hint: string }> = {
  ...
  'transactions.access': { module: 'Transactions', label: 'Accéder à Transactions', hint: 'Entrer dans Transactions.' },
  'transactions.create': { module: 'Transactions', label: 'Créer une transaction', hint: 'Créer une transaction.' },
  'transactions.manage.own': { module: 'Transactions', label: 'Gérer ses transactions', hint: 'Modifier/annuler ses transactions uniquement.' },
  'transactions.manage.any': { module: 'Transactions', label: 'Gérer toutes les transactions', hint: 'Modifier/annuler les transactions de tous.' },
  ...
  'transactions.recent.access': { module: 'Transactions récentes', label: 'Accéder à Transactions récentes', hint: 'Entrer dans Transactions récentes.' },
  'transactions.recent.create': { module: 'Transactions récentes', label: 'Créer depuis transactions récentes', hint: 'Créer/dupliquer depuis les transactions récentes.' },
  'transactions.recent.manage.own': { module: 'Transactions récentes', label: 'Gérer ses transactions récentes', hint: 'Modifier/annuler ses transactions récentes.' },
  'transactions.recent.manage.any': { module: 'Transactions récentes', label: 'Gérer toutes les transactions récentes', hint: 'Modifier/annuler toutes les transactions récentes.' },
  ...
  'activity.access': { module: 'Activité', label: 'Accéder à Activité', hint: 'Entrer dans Activité.' },
  'activity.view': { module: 'Activité', label: 'Voir les activités récentes', hint: 'Afficher les activités récentes.' },
  'activity.create': { module: 'Activité', label: 'Créer une activité', hint: 'Créer une activité.' },
  ...
  'activity.manage.own': { module: 'Activité', label: 'Gérer ses activités', hint: 'Modifier/annuler ses activités.' },
  'activity.manage.any': { module: 'Activité', label: 'Gérer toutes les activités', hint: 'Modifier/annuler toutes les activités.' },
  ...
  'four.access': { module: 'FOUR', label: 'Accéder à FOUR', hint: 'Entrer dans FOUR.' },
  'four.create': { module: 'FOUR', label: 'Créer/Ouvrir une session FOUR', hint: 'Ouvrir une session FOUR.' },
  'four.manage.own': { module: 'FOUR', label: 'Gérer sa session FOUR', hint: 'Modifier sa session FOUR active.' },
  'four.manage.any': { module: 'FOUR', label: 'Gérer toutes les sessions FOUR', hint: 'Modifier toutes les sessions FOUR.' },
  'four.close': { module: 'FOUR', label: 'Clôturer une session FOUR', hint: 'Clôturer la session FOUR.' },
