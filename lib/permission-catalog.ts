...
export const PERMISSION_LABELS: Record<string, { module: string; label: string; hint: string }> = {
  ...
  'drugs.transfo.receive.validate': { module: 'Drogues', label: 'Valider une réception de transfo', hint: 'Valider la réception d’une transfo.' },
  'drugs.transfo.cancel.own': { module: 'Drogues', label: 'Annuler ses propres transfos', hint: 'Annuler une transfo créée par soi.' },
  'drugs.transfo.cancel.any': { module: 'Drogues', label: 'Annuler toutes les transfos', hint: 'Annuler n’importe quelle transfo.' },
  'drugs.transfo.edit.own': { module: 'Drogues', label: 'Modifier ses propres transfos', hint: 'Modifier une transfo créée par soi.' },
  ...
  'drugs.sales.preview': { module: 'Drogues', label: 'Voir la bulle Vente drogue', hint: 'Afficher la partie ventes drogue.' },
  'drugs.sales.view': { module: 'Drogues', label: 'Voir les ventes drogue', hint: 'Afficher les ventes drogue.' },
  'drugs.sales.create': { module: 'Drogues', label: 'Créer vente drogue', hint: 'Créer une session de vente drogue.' },
  'drugs.sales.edit.own': { module: 'Drogues', label: 'Modifier ses propres ventes drogue', hint: 'Modifier ses ventes drogue.' },
  'drugs.sales.edit.any': { module: 'Drogues', label: 'Modifier toutes les ventes drogue', hint: 'Modifier toutes les ventes drogue.' },
  'drugs.sales.cancel.own': { module: 'Drogues', label: 'Annuler ses propres ventes drogue', hint: 'Annuler ses ventes drogue.' },
